...
public class DubboItemService implements IDubboItemService {
    ...
    public BaseResponse listItemsHttp(ItemVO itemVO) {
        log.info("请求过来的参数：{} ",itemVO);
        BaseResponse response=new BaseResponse(StatusCode.Success);
        ItemInfo itemInfo = new ItemInfo();
        itemInfo.setCode(itemVO.getCode());
        itemInfo.setName(itemVO.getName());
        List<ItemInfo> itemInfos = itemInfoMapper.selectHttp(itemInfo);
